...
public class ParserTopologyBuilder {
  ...
  public static TopologyBuilder build(String zookeeperUrl,
    ...
    return build(zookeeperUrl, brokerUrl, sensorType, offset, spoutParallelism, spoutNumTasks, parserParallelism, parserNumTasks, invalidWriterParallelism, invalidWriterNumTasks, errorWriterParallelism, errorWriterNumTasks, 1048576, 1048576);
  }
